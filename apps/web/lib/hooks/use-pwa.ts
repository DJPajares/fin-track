...
const getInitialPwaState = (): PWAState => {
  const { isInstallable, isInstalled, isIOS } = getInstallabilityState();
...
export function usePWA() {
  const [pwaState, setPwaState] = useState<PWAState>(getInitialPwaState);
